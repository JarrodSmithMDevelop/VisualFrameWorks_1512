...
@interface Smith_Jarrod_Project1Object : KrollCoverageObject {
#else
@interface Smith_Jarrod_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Jarrod_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Jarrod_Project1Object *_smith_jarrod_project1;
    KrollObject* console;
	BOOL shutdown;
