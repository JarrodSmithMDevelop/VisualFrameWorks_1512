...
//@interface Smith_Jarrod_Project1Object : NSObject
//@end

@interface Smith_Jarrod_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Smith_Jarrod_Project1Object class]])
		{
			for (NSString *key in [[(Smith_Jarrod_Project1Object*)o modules] allKeys])
			{
