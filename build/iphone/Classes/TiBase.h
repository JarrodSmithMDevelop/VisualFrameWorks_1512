...
// in simulator we redefine to format for Smith_Jarrod_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_jarrod_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_jarrod_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Jarrod_Project1NativeItemNone = -1, 
	UISmith_Jarrod_Project1NativeItemSpinner = -2,
	UISmith_Jarrod_Project1NativeItemProgressBar = -3,
	
	UISmith_Jarrod_Project1NativeItemSlider = -4,
	UISmith_Jarrod_Project1NativeItemSwitch = -5,
	UISmith_Jarrod_Project1NativeItemMultiButton = -6,
	UISmith_Jarrod_Project1NativeItemSegmented = -7,
	
	UISmith_Jarrod_Project1NativeItemTextView = -8,
	UISmith_Jarrod_Project1NativeItemTextField = -9,
	UISmith_Jarrod_Project1NativeItemSearchBar = -10,
	
	UISmith_Jarrod_Project1NativeItemPicker = -11,
	UISmith_Jarrod_Project1NativeItemDatePicker = -12,
	
	UISmith_Jarrod_Project1NativeItemInfoLight = -13,
	UISmith_Jarrod_Project1NativeItemInfoDark = -14,
	
	UISmith_Jarrod_Project1NativeItemDisclosure = -15,
	
	UISmith_Jarrod_Project1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Jarrod_Project1 instances of
