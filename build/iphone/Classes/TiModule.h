...
/**
 The base class for all Smith_Jarrod_Project1 modules
 */
...
/**
 Smith_Jarrod_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Smith_Jarrod_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Smith_Jarrod_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Smith_Jarrod_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Smith_Jarrod_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
