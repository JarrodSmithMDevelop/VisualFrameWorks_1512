...
//Rare exceptions to indicate a bug in the _smith_jarrod_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Smith_Jarrod_Project1 proxies.
 */
