...
/**
 Base class for all Smith_Jarrod_Project1 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Smith_Jarrod_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
